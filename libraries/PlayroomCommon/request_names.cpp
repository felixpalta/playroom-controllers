...
static const RqTypeString rq_types[] =
{
  ...
  RQ_TYPE_STRBUF_AND_LEN(RQ_TYPE_BARREL_WAIT, TYPE_ATTR_BARREL_WAIT_VALUE),
  RQ_TYPE_STRBUF_AND_LEN(RQ_TYPE_DOOR_LOCK, TYPE_ATTR_DOOR_LOCK_VALUE),
  RQ_TYPE_STRBUF_AND_LEN(RQ_TYPE_DOOR_UNLOCK, TYPE_ATTR_DOOR_UNLOCK_VALUE),
  RQ_TYPE_STRBUF_AND_LEN(RQ_TYPE_CURTAIN_OPEN, TYPE_ATTR_CURTAIN_OPEN_VALUE),
  RQ_TYPE_STRBUF_AND_LEN(RQ_TYPE_CURTAIN_CLOSE, TYPE_ATTR_CURTAIN_CLOSE_VALUE),
  RQ_TYPE_STRBUF_AND_LEN(RQ_TYPE_SECTORS_ALL_ON, TYPE_ATTR_SECTORS_ALL_ON_VALUE),
  RQ_TYPE_STRBUF_AND_LEN(RQ_TYPE_SECTORS_ALL_OFF, TYPE_ATTR_SECTORS_ALL_OFF_VALUE),
  RQ_TYPE_STRBUF_AND_LEN(RQ_TYPE_SECTOR_PLAY, TYPE_ATTR_SECTOR_PLAY_VALUE),
};
